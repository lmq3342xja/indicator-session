...
create_settings_section (IndicatorSessionService * self)
{
  ...
  g_menu_append (menu, _("Ubuntukylin Suggestion…"), "indicator.suggestions");
...
static void startChildApp(const char *app_exe)
{
    /* exec command */
    pid_t child_pid;
...
static void
on_suggestions_activated (GSimpleAction * a      G_GNUC_UNUSED,
                       GVariant      * param  G_GNUC_UNUSED,
                       gpointer        gself)
{
	startChildApp("ubuntukylin-feedback");
}
static void
...
init_gactions (IndicatorSessionService * self)
{
  ...
  GActionEntry entries[] = {
    ...
    { "suggestions",            on_suggestions_activated     },
